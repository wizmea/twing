...
class TwingNodeVisitorSafeAnalysis extends base_node_visitor_1.TwingBaseNodeVisitor {
    ...
    doLeaveNode(node, env) {
        if (node.getType() === node_1.TwingNodeType.EXPRESSION_CONSTANT) {
        ...
        else if (node.getType() === node_1.TwingNodeType.EXPRESSION_PARENT) {
            // parent block is safe by definition
            this.setSafe(node, ['all']);
        }
        else if (node.getType() === node_1.TwingNodeType.EXPRESSION_CONDITIONAL) {
        ...
        else if (node.getType() === node_1.TwingNodeType.EXPRESSION_FUNCTION) {
        ...
        else if (node.getType() === node_1.TwingNodeType.EXPRESSION_GET_ATTR && node.getNode('node').getType() === node_1.TwingNodeType.EXPRESSION_NAME) {
