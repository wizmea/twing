...
`);
     ...
     * @param {TwingSource} source
     */
    enterSourceMapBlock(line, column, nodeType, source) {
        output_buffering_1.TwingOutputBuffering.obStart();
    ...
    leaveSourceMapBlock() {
        this.sourceMapNode.content = output_buffering_1.TwingOutputBuffering.obGetFlush();
