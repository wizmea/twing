...
export declare abstract class TwingEnvironment extends EventEmitter {
     ...
     */
    getSourceMapNodeFactory(nodeType: TwingNodeType): TwingSourceMapNodeFactory;
    /**
     ...
     * @param {TwingSource} source
     */
    enterSourceMapBlock(line: number, column: number, nodeType: TwingNodeType, source: TwingSource): void;
    leaveSourceMapBlock(): void;
    getSourceMap(): string;
    enableSandbox(): void;
    disableSandbox(): void;
    isSandboxed(): boolean;
