 ...
 */
export declare function date(env: TwingEnvironment, date: Date | DateTime | Duration | number | string, timezone?: string | null | false, locale?: string | null | false): Promise<DateTime | Duration>;
